...
<body>
	...
	<div id='main'>
		<div id='content'/>
			...
			$sql = "select * from furniture where type_of_furniture like '%$search%' or color like '%$search%' or cost like '%$search%' or quantity like '%$search%' or material like '%$search%' or a_date like '%$search%' ";
